...
var script_invalid = require('../data/squared/script_invalid');
var tx_valid = require('../data/squared/tx_valid');
var tx_invalid = require('../data/squared/tx_invalid');

//the script string format used in squared data tests
...
describe('Interpreter', function() {
  ...
  describe('squared script evaluation fixtures', function() {
  ...
  describe('squared transaction evaluation fixtures', function() {
      ...
      set.forEach(function(vector) {
        ...
        it('should pass tx_' + (expected ? '' : 'in') + 'valid vector ' + cc, function() {
          ...
          inputs.forEach(function(input) {
            ...
            if (txoutnum === -1) {
              txoutnum = 0xffffffff; //squared casts -1 to an unsigned int
            }
