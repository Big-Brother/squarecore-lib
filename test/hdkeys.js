...
var HDPublicKey = squarecore.HDPublicKey;
...
describe('BIP32 compliance', function() {
  ...
  describe('edge cases', function() {
    ...
    it('will handle edge case that derived private key is invalid', function() {
      ...
      var unstubbed = squarecore.crypto.BN.prototype.toBuffer;
      var count = 0;
      var stub = sandbox.stub(squarecore.crypto.BN.prototype, 'toBuffer', function(args) {
      ...
      sandbox.spy(squarecore.PrivateKey, 'isValid');
      var key = HDPrivateKey.fromObject({
        network: 'testnet',
        depth: 0,
        parentFingerPrint: 0,
      ...
      squarecore.PrivateKey.isValid.callCount.should.equal(2);
    });
    it('will handle edge case that a derive public key is invalid', function() {
      ...
      var unstubbed = squarecore.PublicKey.fromPoint;
      squarecore.PublicKey.fromPoint = function() {
        squarecore.PublicKey.fromPoint = unstubbed;
