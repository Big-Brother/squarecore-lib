...
We're working hard to make *squarecore* the most powerful JavaScript library for working with bitcoin. Our goal is to have *squarecore* be a library that can be used by anyone interested in bitcoin, and to level expertise differences with great design and documentation.

## Community

If there are any questions, etc., please feel to ask in one of the community channels:

- https://labs.bitpay.com/c/squarecore (Support Forum)
- https://gitter.im/bitpay/squarecore (Development Chat)
...
These are some global design goals in squarecore that any change must adhere.
...
When possible, squarecore objects should have standard methods on an instance prototype:
...
#### T3 - Require 'squarecore' and Look up Classes from There

This helps to make tests more useful as examples, and more independent of where they are placed. This also helps prevent forgetting to include all submodules in the squarecore object.
...
```sh
git remote add bitpay git@github.com:bitpay/squarecore.git
...
```
Finally go to [github.com/bitpay/squarecore](https://github.com/bitpay/squarecore) in your web browser and issue a new pull request.

Main contributors will review your code and possibly ask for changes before your code is pulled in to the main repository.  We'll check that all tests pass, review the coding style, and check for general code correctness. If everything is OK, we'll merge your pull request and your code will be part of squarecore.

If you have any questions feel free to post them to
[github.com/bitpay/squarecore/issues](https://github.com/bitpay/squarecore/issues).
